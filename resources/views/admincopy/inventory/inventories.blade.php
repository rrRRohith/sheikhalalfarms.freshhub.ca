                                    ...
                                    <table class="table table-list mt-0">
                                       <thead class="table-list-header-options">
                                          <tr>
                                             ...
                                             <td colspan="3">
                                                <a href="{{admin_url('inventories/create')}}"
                                       ...
                                       <tbody>
                                          ...
                                          <tr>
                                             ...
                                             <td data-label="Organization"><label class="">{{date('d F Y',strtotime($w->created_at))}}</label></td>
                                             <td  data-label="Organization"><label class="">{{$w->warehouse['name']}}</label></td>
                                             <td  data-label="Organization"><label class="">{{$w->quantity}}</label></td>
                                          ...
                                          @php $i++;$total+=$w->stock_qty; @endphp
                                          @endforeach
                                          <!--<tr>-->
