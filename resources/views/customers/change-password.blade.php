...
<ul>
    ...
    <li class="active"><a href="{{customer_url('changepassword')}}">Change Password</a></li>
</ul>
@endsection
@section('contents')
                  ...
                  <section class="card-text">
                     ...
                     @endif
                       <section id="panel2" role="tabpanel"
                              ...
                              <div class="content-area">
                                 <form method="POST" action="{{customer_url('changepassword')}}" class="pt-0 passwordchange_form">
                                    @csrf
