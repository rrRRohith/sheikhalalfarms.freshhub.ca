                          ...
                          <div class="card-body">
										<div class="row">
											...
											<div class="col-12 form-group">
											    <h6 class="d-inline-block m-0">From :&nbsp;<strong> {{ !empty($message->sender) ? $message->sender->firstname : ''}}</strong>&nbsp;<
																    {{$message->sender_email}} ></h6>
												...
												<!--<textarea class="form-control" placeholder="Message" name="message" required rows="10">{{$message->message}}</textarea>-->
												 <div class="email-content" style="min-height: 200px;">
											            ...
											            <div class="text-center">
                                                            <a href="{{customer_url('messages')}}"  class="btn text-center" type="submit">Back</a>
                                                        </div>
