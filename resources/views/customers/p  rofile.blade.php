...
@section('page_nav')
<ul>
    <li><a href="{{customer_url('')}}">Dashboard</a></li>
    <li class="active"><a href="{{customer_url('profile')}}">Profile</a></li> 
         ...
         <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 no-xs-padding">
            <div class="card no-margin minH">
               <div class="card-block">
                  ...
                  <!--      <div class="card-title-header-titr"><b> User Profile </b></div>-->
                     ...
                     <section class="card-text">
                        <div class="nav-vertically mb-1">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <img id="uploaded-image"
                                                src="{{old('picture',isset($profile) && $profile->picture != '' ? asset('images/users/'.$profile->id.'/'.$profile->picture):asset('images/users/dummy-image.jpg'))}}">
                           ...
                           <section id="panel1" role="tabpanel"
                              ...
                              <div class="content-area">
                                 <form method="POST" action="{{url('customer/profile')}}" class="pt-0">
                                    @csrf
                           ...
                           <!--   <div class="content-area">-->
                           <!--      <form method="POST" action="{{url('customer/changepassword')}}" class="pt-0">-->
                           <!--         @csrf-->
