                                        ...
                                        <table class="table table-customer mt-0">
                                            ...
                                            <tbody>
                                                ...
                                                @if($w->price_by=='weight')
                                                 @php $total=getWeight($w->orderitem->sum('weight'))*getRate($w->price);@endphp
                                                @else
                                                 @php $total=$w->orderitem->sum('quantity')*getRate($w->price);@endphp
                                                @endif 
                                                    <tr>
                                                        ...
                                                        <td class="text-left" data-label="Organization"><label>{{getWeight($w->orderitem->sum('weight')) .defWeight()}} @php $totweight+=getWeight($w->orderitem->sum('weight')); @endphp</label></td>
