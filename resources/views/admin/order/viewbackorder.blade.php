...
<ul>
    ...
    <li><a  href="{{admin_url('purchaseorders')}}">Purchase Orders</a>
                    ...
                    <div class="card-block">
                        <a href="{{admin_url('backorders')}}/convertbackorder/{{$order->id}}" class="green_button pull-right">Accept this Backorder</a>
			                ...
			                <div class="row">
                    			...
                    			<div class="col-sm-4 backorder_number">
                    			    
                    			        <!--<h5>	<label>Order# :</label> {{$order->po_number}} </h5>-->
                    			
                    			</div>
                    			<div class="col-sm-4 backorder_date">
