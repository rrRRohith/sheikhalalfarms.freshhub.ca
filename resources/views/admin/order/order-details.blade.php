         ...
         <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card no-margin minH">
               <div class="card-block">
                  ...
                  @if($order->status < 4)
                  <a href="{{admin_url('order/printorder')}}/{{$order->id}}" class="green_button pull-right" target="_blank">
                  ...
                  <div class="orderdet_buyerinfo">
                      ...
                      <p>
                        ...
                        <p>  Email : {{$order->email}} </p>
                         ...
                         <p> Shipping Address : {{$order->delivery->address}}, {{$order->delivery->city}}, {{$order->delivery->province}} ,{{$order->delivery->postalcode}} </p>
                         
                         <p> Billing Address : {{$order->billing->address}}, {{$order->billing->city}}, {{$order->billing->province}}, {{$order->billing->postalcode}} </p>
                      </div>
