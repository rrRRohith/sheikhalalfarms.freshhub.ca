...
<body style="background-color:#ffffff;color:#000000;">
    <div class="container mt-5">
        ...
        <h2 class="text-center"><label class="font-weight-bold" style="font-family: 'Open Sans', sans-serif;font-size:25px;">Purchase Order</label></h2>
