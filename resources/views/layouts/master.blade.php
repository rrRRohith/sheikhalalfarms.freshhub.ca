         ...
         <header class="header">
               ...
               <div class="header-profile dropdown js-header-profile" data-url="/calendar/getnotification">
                  ...
                  <div class="header-profile-dropdown-menu dropdown-menu">
                     <div class="header-flex-between header-not-notification border-b pb-1 js-switch-profile-dropdown ">
                        <div><a href="{{admin_url('profile')}}"
                           class="text-dark">{{Auth::user()->username}}</a></div>
                        <div class="header-flex-between">
                           <a href="{{admin_url('profile')}}" class="text-success">Profile</a>
               ...
               <ul class="header-tab-box">
                  ...
                  <div class="header-submenu header-flex-reverse-between header-submenu-hide">
                     <ul class="header-submenu-main header-flex-between">
                        ...
                        <li class="header-submenu-main-item ">
                           <a @if($submenu=='customertype') class="header-submenu-main-link active" @else class="header-submenu-main-link " @endif
                           href="{{url('admin/customertype')}}">Customer Types</a>
                        </li>
                     </ul>
                  </div>
                  </li>
                  ...
                  <a @can('Inventory View') href="{{url('admin/inventories')}}" @endcan>
                  ...
                  <div class="header-submenu header-flex-reverse-between header-submenu-hide">
                     <ul class="header-submenu-main header-flex-between">
                        ...
                        @endcan
                        <li class="header-submenu-main-item">
                           <a @if($submenu=='stock') class="header-submenu-main-link active" @else class="header-submenu-main-link " @endif
                           href="{{url('admin/inventories/current-stock')}}">Stock</a>
                        </li>
                     </ul>
                  </div>
                  </li>
                  ...
                  <li class="header-tab-item  ">
                     ...
                     <div class="header-submenu header-flex-reverse-between header-submenu-hide">
                        <ul class="header-submenu-main header-flex-between">
                           ...
                           <!--      href="{{admin_url('orders')}}">Pending Orders</a>-->
                           <!--</li>-->
                           <li class="header-submenu-main-item">
                              <a class="header-submenu-main-link  "
                                 href="{{admin_url('orders')}}">All Orders</a>
                           </li>
                           <li class="header-submenu-main-item ">
                              <a class="header-submenu-main-link  "
                                 href="{{admin_url('invoices')}}">Invoices</a>
                           </li>
                           <!--<li class="header-submenu-main-item ">-->
                           <!--   <a class="header-submenu-main-link  "-->
                           <!--      href="{{admin_url('invoices')}}">Unpaid Invoices</a>-->
                           <!--</li>-->
                        </ul>
                     </div>
                  </li>
                  ...
                  <div class="header-submenu header-flex-reverse-between header-submenu-hide">
                     <ul class="header-submenu-main header-flex-between">
                        ...
                        <li class="header-submenu-main-item">
                           <a @if($submenu=='Roles') class="header-submenu-main-link active" @else class="header-submenu-main-link " @endif
                           href="{{url('admin/roles')}}">Roles & Permissions</a>
                        </li>
                        <li class="header-submenu-main-item">
                           <a  @if($submenu=='Emails') class="header-submenu-main-link active" @else class="header-submenu-main-link " @endif
                           href="{{url('admin/emails')}}">Email</a>
                        </li>
                     </ul>
                  </div>
                  </li>
            ...
            <form action="{{admin_url('search')}}" method="get">
                		<div class="input-group">
                            <input type="text" class="form-control" placeholder="Search here ..." name="keyword" @if(isset(request()->keyword)) value="{{request()->keyword}}" @endif>
