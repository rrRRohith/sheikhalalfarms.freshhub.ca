...
use PDF;
class CintaOrdersController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $orderquery=Order::with(['item'=>function($query){$query->with('product');}])->select('orders.id','users.firstname','users.phone','users.lastname','orders.order_date','orders.shipping_date','orders.grand_total','orders.status','orders.email','users.business_name','users.customer_type','orders.user_id','users.sales_rep')->join('users','users.id','=','orders.user_id');
